...
'';
  ...
  relayRoute = lib.optionalString cfg.relay.enable ''
Routes:
${indent 1}-
${indent 2}Transport: ${cfg.relay.transportName}
'';
in {
...
${indent 3}KeyCerts:
${indent 4}-
${indent 5}CertFile: tls/${cfg.certName}-chain.pem
${indent 5}KeyFile: tls/${cfg.certName}-key.pem
